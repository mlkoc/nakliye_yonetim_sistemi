...
public class yedeklemeEkran extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtYedekleme, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 150, 461, -1));

        tusKlasor.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        tusKlasor.setForeground(new java.awt.Color(0, 51, 102));
        tusKlasor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/search_1.png"))); // NOI18N
        ...
        jPanel1.add(tusKlasor, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 150, -1, -1));

        tusYedekle.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        tusYedekle.setForeground(new java.awt.Color(0, 51, 102));
        tusYedekle.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/edit_1.png"))); // NOI18N
        ...
        jPanel1.add(tusYedekle, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 240, 130, 47));
        jPanel1.add(lblBilgi, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 300, 720, 50));

        jButton1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jButton1.setForeground(new java.awt.Color(0, 51, 102));
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/back_1.png"))); // NOI18N
        ...
        jLabel13.setText("Data Yedekleme Paneli");
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 70, -1, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 51, 255));
        jLabel2.setText("Dosya Yolu");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 150, -1, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/koc_sistem.PNG"))); // NOI18N
